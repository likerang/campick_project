    ...
    <>
      ...
      <div className={styles.product_detail_content}>
        ...
        <div className={styles.product_detail_info}>
          <span className={`small_tr ${styles.selected_brand}`}>헬레베르그</span>
          <h3 className={styles.product_title}>[상품 타이틀]</h3>
          <span className={`medium_tb ${styles.product_price}`}>1,893,000 원</span>
          <div className={styles.product_meta}>
            <span className={styles.product_location}>종로1가동</span>
            <span className={styles.product_date}>4시간 전</span>
          </div>
          {/* tag_list */}
          ...
          <li className="product_card">
            <a href="#">
              ...
              <div className="product_info">
                <h3 className="product_title">[힐레베르그] 알락 2 텐트 (Allak 2)</h3>
